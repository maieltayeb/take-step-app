...
export const getAllVolunteers = () => dispatch => {
  axios
    .get("https://take-step-api.herokuapp.com/volunteer/getAllVolunteers")
    .then(response => {
...
export const SignupVolunteers = newUser => dispatch => {
  return axios
    .post("https://take-step-api.herokuapp.com/volunteer/register", newUser)
    .then(response => {
      const { data } = response;
...
export const logInVolunteers = currentUser => dispatch => {
  return axios
    .post("https://take-step-api.herokuapp.com/volunteer/login", currentUser)
    .then(response => {
...
export const volunteeredit = (id, newUser) => dispatch => {
  ...
  return axios
    .patch(`https://take-step-api.herokuapp.com/volunteer/Edit/${id}`, newUser, {
      headers: headers
    })
    .then(response => {
      const { data } = response;
...
export const getVolunteerById = id => dispatch => {
  return axios
    .get(`https://take-step-api.herokuapp.com/volunteer/${id}`)
    .then(response => {
