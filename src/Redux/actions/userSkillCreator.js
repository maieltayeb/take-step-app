...
export const getSkillById = id => dispatch => {
  axios
    .get(`https://take-step-api.herokuapp.com/volunteer/getSkillById/${id}`, {
...
export const getUserSkills = id => dispatch => {
  axios
    .get(`https://take-step-api.herokuapp.com/volunteer/getUserSkills/${id}`, {
      headers: { authorization: localStorage.getItem("token") }
    })
...
export const AddSkills = skillsAdded => dispatch => {
  axios
    .post(`https://take-step-api.herokuapp.com/volunteer/addSkill`, skillsAdded, {
      headers: { authorization: localStorage.getItem("token") }
    })
    .then(res => {
...
export const DeletSkills = (volunteerId, skillId) => dispatch => {
  axios
    .delete(
      `https://take-step-api.herokuapp.com/volunteer/delete_skill/${volunteerId}/${skillId}`,
      {
        headers: { authorization: localStorage.getItem("token") }
      }
    )
