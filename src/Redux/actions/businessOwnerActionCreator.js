...
export const getAllUsersBussinessOwner = () => dispatch => {
  axios
    .get("https://take-step-api.herokuapp.com/bussinessOwner/getAllBussinessUsers")
    .then(response => {
...
export const getUserById = id => dispatch => {
  return axios
    .get(`https://take-step-api.herokuapp.com/bussinessOwner/${id}`)
    .then(response => {
...
export const SignupBussinessOwner = newUser => dispatch => {
  return axios
    .post("https://take-step-api.herokuapp.com/bussinessOwner/register", newUser)
    .then(response => {
      const { data } = response;
...
export const logInBussinessOwner = currentUser => dispatch => {
  return axios
    .post("https://take-step-api.herokuapp.com/bussinessOwner/login", currentUser)
    .then(response => {
...
export const getAllCountries = () => dispatch => {
  return axios
    ...
    .get("https://take-step-api.herokuapp.com/country/getAllcountries")
    .then(response => {
...
export const editbussinessOwner = (id, newUser) => dispatch => {
  ...
  return axios
    .patch(`https://take-step-api.herokuapp.com/bussinessOwner/Edit/${id}`, newUser, {
      headers: headers
    })
    .then(response => {
      const { data } = response;
